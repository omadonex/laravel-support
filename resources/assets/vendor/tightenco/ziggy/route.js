...
class Router extends String {
    constructor(name, params, absolute, customZiggy) {
        super();
    ...
    matchUrl() {
        const location = omx.global.window.location;

        let windowUrl = location.hostname + (location.port ? ':' + location.port : '') + location.pathname;
